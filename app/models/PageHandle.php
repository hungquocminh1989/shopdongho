    ...
    public function selectPage_CategoryData($m_category_id){
		...
		return $this->query(
			"
				...
				INNER JOIN m_category mc ON mc.m_category_id = spd.meta_id AND spd.meta_type = ".SYSTEM_META_CATEGORY."
		...
		return $this->query(
			"
				SELECT 
					*
				FROM m_site_page_detail spd
				INNER JOIN m_site_content c ON c.m_site_content_id = spd.meta_id AND spd.meta_type = ".SYSTEM_META_FREE_SECTION."
