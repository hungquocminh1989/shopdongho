...
! function(t, e, i) {
    ...
    var n = 0,
        ...
        m = "groups",
        y = function(e, i) {
            i = i || {}, t.extend(this, y.options, i, y.settings), this.$el = t(e), this.$window = t(window), this.unique = "shuffle_" + n++, this._fire(y.EventType.LOADING), this._init(), setTimeout(t.proxy(this._fire, this, y.EventType.DONE), 16)
        };
    y.EventType = {
        LOADING: "loading",
        DONE: "done",
        ...
        _init: function() {
            var e, i, s = this,
                ...
                o = s.throttle ? s.throttle(s.throttleTime, n) : n,
                a = s.initialSort ? s.initialSort : null;
            s._setVars(), s._resetCols(), s._addClasses(), s._initItems(), s.$window.on("resize." + c + "." + s.unique, o), e = s.$el.css(["paddingLeft", "paddingRight", "position"]), i = s._getOuterWidth(s.$el[0]), "static" === e.position && (s.$el[0].style.position = "relative"), s.offset = {
        ...
        _setVars: function() {
            var e = this,
                i = e.columnWidth;
            e.$items = e._getItems(), e.isFluid = i && t.isFunction(e.columnWidth), 0 === i && null !== e.sizer && (i = e.sizer), "string" == typeof i ? e.$sizer = e.$el.find(i) : i && i.nodeType && 1 === i.nodeType ? e.$sizer = t(i) : i && i.jquery && (e.$sizer = i), e.$sizer && e.$sizer.length && (e.useSizer = !0, e.sizer = e.$sizer[0])
        },
        _filter: function(e, s) {
            var n = this,
                ...
                o = r ? s : n.$items,
                a = t();
            return e = e || n.lastFilter, n._fire(y.EventType.FILTER), t.isFunction(e) ? o.each(function() {
                var i = t(this);
        ...
        _setTransition: function(t) {
            var e = this;
            return t.style[r] = h + " " + e.speed + "ms " + e.easing + ", opacity " + e.speed + "ms " + e.easing, t
        },
        ...
        _setSequentialDelay: function(e) {
            ...
            i.supported && t.each(e, function(e) {
                this.style[o] = "0ms," + (e + 1) * i.sequentialFadeDelay + "ms", t(this).one(l, function() {
                    this.style[o] = "0ms"
                })
            })
        },
        ...
        _getOuterWidth: function(t, e) {
            var i = t.offsetWidth;
            if (e) {
                var s = Math.round(parseFloat(t.style.marginLeft)) || 0,
                    n = Math.round(parseFloat(t.style.marginRight)) || 0;
                i += s + n
            }
            return i
        },
        _getColumnSize: function(t, e) {
            var i;
            return i = this.isFluid ? this.columnWidth(e) : this.useSizer ? this._getPreciseDimension(this.sizer, "width") : this.columnWidth ? this.columnWidth : this.$items.length > 0 ? this._getOuterWidth(this.$items[0], !0) : e, 0 === i && (i = e), i + t
        },
        ...
        _layout: function(e, i, s, n) {
            var r = this;
            i = i || r.filterEnd, r.layoutTransitionEnded = !1, t.each(e, function(e, o) {
                var a = t(o),
                    l = r._getOuterWidth(o, !0),
                    u = l / r.colWidth;
                Math.abs(Math.round(u) - u) < .03 && (u = Math.round(u));
                var h = Math.min(Math.ceil(u), r.cols);
                if (1 === h) r._placeItem(a, r.colYs, i, s, n);
                else {
                    var d, f, c = r.cols + 1 - h,
                        p = [];
                    for (f = 0; c > f; f++) d = r.colYs.slice(f, f + h), p[f] = Math.max.apply(Math, d);
                    r._placeItem(a, p, i, s, n)
                }
        ...
        _placeItem: function(t, e, i, s, n) {
            ...
            var h = r.colWidth * a,
                d = o;
            h = Math.round(h + r.offset.left), d = Math.round(d + r.offset.top), t.data({
                x: h,
                y: d
            });
            var f = o + t.outerHeight(!0),
                c = r.cols + 1 - u;
            for (l = 0; c > l; l++) r.colYs[a + l] = f;
            var p = {
                from: "layout",
                $this: t,
                x: h,
            ...
            s ? p.skipTransition = !0 : (p.opacity = 1, p.callback = i), n && (p.opacity = 0), r.styleQueue.push(p)
        },
        _shrink: function(e, i) {
            var s = this,
                ...
                r = {},
                o = i || s.shrinkEnd;
            n.length && (s._fire(y.EventType.SHRINK), s.shrinkTransitionEnded = !1, n.each(function() {
                var e = t(this),
                    i = e.data();
                r = {
                    from: "shrink",
        ...
        transition: function(e) {
            var s, n = this,
                r = function() {
                    n.layoutTransitionEnded || "layout" !== e.from ? n.shrinkTransitionEnded || "shrink" !== e.from || (e.callback.call(n), n.shrinkTransitionEnded = !0) : (n._fire(y.EventType.LAYOUT), e.callback.call(n), n.layoutTransitionEnded = !0)
                };
            if (e.callback = e.callback || t.noop, n.supported) e.scale === i && (e.scale = 1), s = f ? "translate3d(" + e.x + "px, " + e.y + "px, 0) scale3d(" + e.scale + ", " + e.scale + ", 1)" : "translate(" + e.x + "px, " + e.y + "px) scale(" + e.scale + ", " + e.scale + ")", e.x !== i && e.$this.css(u, s), e.opacity !== i && e.$this.css("opacity", e.opacity), e.$this.one(l, r);
            else {
                var o = {
                    left: e.x,
                    top: e.y,
                ...
                e.$this.stop(!0).animate(o, n.speed, "swing", r)
            }
        },
        ...
        shrinkEnd: function() {
            this._fire(y.EventType.SHRUNK)
        },
        filterEnd: function() {
            this._fire(y.EventType.FILTERED)
        },
        sortEnd: function() {
            this._fire(y.EventType.SORTED)
        },
        _skipTransition: function(e, i, s) {
            var n, r = e.style[a];
            e.style[a] = "0ms", t.isFunction(i) ? i() : e.style[i] = s, n = e.offsetWidth, e.style[a] = r
        },
        _addItems: function(t, e, s) {
            var n, r, o = this;
            o.supported || (e = !1), t.addClass("shuffle-item"), o._initItems(t), o._setTransitions(t), o.$items = o._getItems(), t.css("opacity", 0), n = o._filter(i, t), r = n.get(), o._updateItemCount(), e ? (o._layout(r, null, !0, !0), s && o._setSequentialDelay(n), o._revealAppended(n)) : o._layout(r)
        },
        ...
        shuffle: function(t, e) {
            var i = this;
            i.enabled && (t || (t = p), i._filter(t), i.lastFilter = t, i._updateItemCount(), i._resetCols(), i._shrink(), e && (i.lastSort = e), i._reLayout())
        },
        sort: function(t, e, i) {
            var s = this,
                n = s.$items.filter(".filtered").sorted(t);
            e || s._resetCols(), s._layout(n, function() {
                e && s.filterEnd(), s.sortEnd()
            }, i), s.lastSort = t
        },
        resized: function(t) {
            ...
            if (t.length && t.jquery) {
                ...
                return e._shrink(t, function() {
                    ...
                    t.remove(), setTimeout(function() {
                        e.$items = e._getItems(), e.layout(), e._updateItemCount(), e._fire(y.EventType.REMOVED, [t, e]), t = null
                    }, 0)
        ...
        return this.each(function() {
            var s = t(this),
                n = s.data(c);
            n || (n = new y(s, e), s.data(c, n)), "string" == typeof e && n[e] && n[e].apply(n, i)
        })
