<?php
/**
 * The file for the Support_Bool class
 *
...
class Support_Bool 
{
	 ...
	 * For example:
	 *
	 *     Support_Bool::booltostr(true);             // returns (string) 'true'
	 *     Support_Bool::booltostr(true, 'yes-no');   // returns (string) 'true'
	 *     Support_Bool::booltostr(false, 'on-off');  // returns (string) 'off'
	 *
	 * @since  0.1.0
	 *
	 ...
	 * For example...
	 *
	 *     Support_Bool::val("");              // returns (bool) false
	 *     Support_Bool::val(true);            // returns (bool) true
	 *     Support_Bool::val(0);               // returns (bool) false
	 *     Support_Bool::val(0.0);             // returns (bool) false
	 *     Support_Bool::val('0');             // returns (bool) false
	 *     Support_Bool::val('abc');           // returns (bool) true
	 *     Support_Bool::val('true');          // returns (bool) true
	 *     Support_Bool::val('on');            // returns (bool) true
	 *     Support_Bool::val('yes');           // returns (bool) true
	 *     Support_Bool::val('off');           // returns (bool) false
	 *     Support_Bool::val([]);              // returns (bool) false
	 *     Support_Bool::val([1, 2]);          // returns (bool) true
	 *     Support_Bool::val(new StdClass());  // returns (bool) true
	 * 
	 * @since  0.1.0
	 *
