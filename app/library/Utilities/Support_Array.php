...
{	
	 ...
	 *
	 *     $a = ['foo', 'bar', 'baz'];
	 *     Support_Array::filterByKey($a, function ($k) {
	 *         return $k > 1;
	 *     });  // returns ['baz']
	 *
	 * @since 0.1.0
	 ...
	 * For example:
	 *     $a = ['foo' => 'bar', 'baz' => 'qux'];
	 *     Support_Array::filterByKeyPrefix($a, 'b');  // returns ['baz']
	 *
	 * @since  0.1.0
	 *
	 * @param  array   $array   the array to filter
	 ...
	 * For example:
	 *
	 *     Support_Array::inArray('foo', ['foo', 'bar']);  // returns true
	 *     Support_Array::inArray('qux', ['foo', 'bar']);  // returns false
	 *     Support_Array::inArray('fo*', ['foo', 'bar']);  // returns true
	 *     Support_Array::inArray('*oo', ['foo', 'bar']);  // returns true
	 *     Support_Array::inArray('*o*', ['foo', 'bar']);  // returns true
	 * 
	 * @since  0.1.0
	 *
	 ...
	 * For example:
	 *
	 *     Support_Array::isAssoc([1, 2, 3]);                       // returns false
	 *     Support_Array::isAssoc(['foo', 'bar', 'baz']);           // returns false
	 *     Support_Array::isAssoc(['1' => 'foo', 2 => 'bar']);      // returns false (PHP casts '1' to 1)
	 *     Support_Array::isAssoc(['1' => 'foo', 8 => 'bar']);      // returns false (sparse doens't matter)
	 *     Support_Array::isAssoc(['1' => 'foo', 'bar' => 'baz']);  // returns true
	 *
	 * @since  0.1.0
	 *
	 ...
	 *
	 *     $a = [['a' => 3], ['a' => 1], ['a' => 2]];
	 *     Support_Array::usort_field($a, 'a'); // returns [['a' => 1], ['a' => 2], ['a' => 3]]
	 * 
	 * @since  0.1.0
	 *
