...
class Support_Str
{
	 ...
	 * For example:
	 *
	 *     Support_Str::endsWith('foobar', 'bar');  // returns true
	 *     Support_Str::endsWith('foobar', 'baz');  // returns false
	 *     Support_Str::endsWith('foobar', 'BAR');  // returns false
	 *     Support_Str::endsWith('foobar', '');     // returns false
	 *     Support_Str::endsWith('', 'foobar');     // returns false
	 * 
	 * @since  0.1.0
	 *
	 ...
	 *
	 * @see  \Jstewmc\PhpHelpers\Support_Str::iEndsWith()  case-insensitive version
	 ...
	 * @throws  \InvalidArgumentException  if $needle is not a string
	 *
	 * @see  \Jstewmc\PhpHelpers\Support_Str::iEndsWith()  case-sensitive version
	 */
	 ...
	 * @since  0.1.0
	 *
	 * @see  \Jstewmc\PhpHelpers\Support_Str::isBool()
	 */
	 ...
	 *     Support_Str::is_bool(true);   // returns false
	 *
	 *     is_bool('true');      // returns false
	 *     Support_Str::isBool('true');  // returns true
	 *
	 *     is_bool('yes');       // returns false
	 *     Support_Str::isBool('yes');   // returns true
	 *
	 * @since  0.1.0 
	 *
	 ...
	 * For example:
	 *
	 *     Support_Str::iStartsWith('foobar', 'bar');  // returns false
	 *     Support_Str::iStartsWith('foobar', 'foo');  // returns true
	 *     Support_Str::iStartsWith('foobar', 'FOO');  // returns true
	 *     Support_Str::iStartsWith('', 'foobar');     // returns false
	 *     Support_Str::iStartsWith('foobar', '');     // returns false
	 *
	 * @since  0.1.0
	 *
	 ...
	 * @throws  \InvalidArgumentException  if $needle is not a string
	 *
	 * @see     \Jstewmc\PhpHelpers\Support_Str::startsWith()  case-sensitive version
	 */ 
	 ...
	 *
	 *     $rules = ['upper' => 12];
	 *     $a = Support_Str::password(12, $rules);
	 *
	 *     $rules = ['lower' => 6, 'upper' => 6];
	 *     $b = Support_Str::password(12, $rules);
	 *
	 *     $rules = ['lower' => 4, 'upper' => 4, 'number' => 4];
	 *     $c = Support_Str::password(12, $rules);
	 *
	 ...
	 * For example:
	 *
	 *     echo Support_Str::rand(8, 'alpha');              // example 'hbdrckso'
	 *     echo Support_Str::rand(8, ['lower', 'number']);  // example 'k987hb54'
	 *     echo Support_Str::rand(8, ['upper', 'symbol']);  // example 'HG!V*X]@'
	 *
	 * @since  0.1.0
	 *
	 ...
	 * For example:
	 *
	 *     Support_Str::splitOnFirstAlpha("123");        // returns ["123"]
	 *     Support_Str::splitOnFirstAlpha("abc");        // returns ["", "abc"]
	 *     Support_Str::splitOnFirstAlpha("123 abc");    // returns ["123", "abc"]
	 *     Support_Str::splitOnFirstAlpha("1 2 3 abc");  // returns ["1 2 3 4", "abc"]
	 * 
	 * @since  0.1.0
	 *
	 ...
	 * For example:
	 *
	 *     Support_Str::startsWith('foobar', 'bar');  // returns false
	 *     Support_Str::startsWith('foobar', 'foo');  // returns true
	 *     Support_Str::startsWith('foobar', 'FOO');  // returns false
	 *     Support_Str::startsWith('foobar', '');     // returns false
	 *     Support_Str::startsWith('', 'foobar');     // returns false
	 *
	 * @since  0.1.0
	 *
	 ...
	 * @throws  \InvalidArgumentException  if $needle is not a string
	 *
	 * @see  \Jstewmc\PhpHelpers\Support_Str::startsWith()  case-insensitive version
	 ...
	 * For example:
	 *
	 *     Support_Str::strtobytes('1K');  // returns 1024
	 *     Support_Str::strtobytes('1M');  // returns 1048576
	 *     Support_Str::strtobytes('1G');  // returns 1073741824
	 *
	 * @since  0.1.0
	 *
	 ...
	 * For example:
	 *
	 *     Support_Str::strtocamelcase('Hello world');   // returns "helloWorld"
	 *     Support_Str::strtocamelcase('H3LLO WORLD!');  // returns "helloWorld"
	 *     Support_Str::strtocamelcase('hello_world');   // returns "helloWorld"
	 * 
	 * @since  0.1.0
	 *
	 ...
	 *
	 *     Support_Str::truncate('Lorem ipsum inum', 8);             // returns 'Lorem ipsum...'
	 *     Support_Str::truncate('Lorem ipsum inum', 8, '');         // returns 'Lorem ip...'
	 *     Support_Str::truncate('Lorem ipsum inum', 8, ' ', ' >');  // returns 'Lorem ipsum >'
	 *
	 * @since  0.1.0
	 *
