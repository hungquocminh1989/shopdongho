 ...
 * Support_Common.php
 *
 * Support_Common.php is a library of helper functions for common tasks such as
...
class Support_Common
{
    ...
    public static function slugify($string, $separator = '-', $css_mode = false)
    {
        ...
        if ($separator === true || $separator === false) {
            ...
            trigger_error(
                'Support_Common::slugify() now takes $css_mode as the third parameter, please update your code',
                E_USER_DEPRECATED
            );
        }
    ...
    public static function http_build_url($url, $parts = array(), $flags = self::HTTP_URL_REPLACE, &$new_url = array())
    {
        ...
        foreach ($keys as $key) {
            ...
            if ($flags & constant('utilphp\\Support_Common::' . $strip)) {
                unset($url[$key]);
            }
        }
     ...
     * and you call Support_Common::array_pluck($array, 'name'), the function will
