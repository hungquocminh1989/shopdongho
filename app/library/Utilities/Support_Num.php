...
class Support_Num 
{
	 ...
	 * For example:
	 *
	 *     Support_Num::bound(1, 0);         // returns 1
	 *     Support_Num::bound(0, 1);         // returns 1
	 *     Support_Num::bound(-1, null, 2);  // returns -1
	 *     Support_Num::bound(3, null, 2);   // returns 2
	 *     Support_Num::bound(2, 1, 3);      // returns 2
	 *     Support_Num::bound(4, 1, 3);      // returns 3
	 * 
	 * @since  0.1.0
	 *
	 ...
	 * For example:
	 *
	 *     Support_Num::ceilTo(5, 2);    // returns 6
	 *     Support_Num::ceilTo(15, 10);  // returns 20
	 *     Support_Num::ceilTo(25, 40);  // returns 40
	 *
	 * @since  0.1.0
	 *
	 ...
	 * For example:
	 *
	 *     Support_Num::floorTo(19, 10);     // returns 10
	 *     Support_Num::floorTo(0.99, 0.5);  // returns 0.5
	 *     Support_Num::floorTo(101, 100);   // returns 100
	 *
	 * @since  0.1.0
	 *
	 ...
	 * @since  0.1.0
	 *
	 * @see  \Jstewmc\PhpHelpers\Support_Num::isInt()
	 */
	 ...
	 * @since  0.1.0
	 *
	 * @see  \Jstewmc\PhpHelpers\Support_Num::isNumeric()
	 */
	 ...
	 * For example:
	 *
	 *     Support_Num::isId('abc');            // returns false
	 *     Support_Num::isId(1.5);              // returns false
	 *     Support_Num::isId(123);              // returns true
	 *     Support_Num::isId(999999, 'small');  // returns false
	 *
	 * @since  0.1.0
	 *
	 ...
	 *     Support_Num::isInt(1);    // returns true
	 *
	 ...
	 * For example:
	 *
	 *     Support_Num::isZero((int) 0);      // returns true
	 *     Support_Num::isZero((float) 0.0);  // returns true
	 *     Support_Num::isZero("0");          // returns true
	 *     Support_Num::isZero("0.0");        // returns true
	 *
	 * I'm particularly useful when combined with PHP's empty() function.
	 *
	 *     $a = ! empty(0);                    // evaluates to false
	 *     $b = ! empty(0) || Support_Num::isZero(0);  // evaluates to true
	 * 
	 * @since  0.1.0
	 *
	 * @param  mixed  $number  the number to test
	 ...
	 * For example:
	 *
	 *     Support_Num::normalize(1, 100);    // returns 0.01
	 *     Support_Num::normalize(50, 100);   // returns 0.5
	 *     Support_Num::normalize(0, 100);    // returns 0
	 *     Support_Num::normalize(150, 100);  // returns 1
	 *
	 * @since   0.1.0
	 *
	 ...
	 * For example:
	 *
	 *     Support_Num::roundTo(7, 2);  // returns 8
	 *     Support_Num::roundTo(7, 4);  // returns 8
	 *     Support_Num::roundTo(7, 8);  // returns 8
	 *
	 * @since  0.1.0
	 *
	 ...
	 * For example:
	 *
	 *     Support_Num::bool(true);           // returns (int) 1
	 *     Support_Num::val(1);               // returns (int) 1
	 *     Support_Num::val('1');             // returns (int) 1
	 *     Support_Num::val(1.5);             // returns (float) 1.5
	 *     Support_Num::val('1.5');           // returns (float) 1.5
	 *     Support_Num::val('1 1/2');         // returns (float) 1.5
	 *     Support_Num::val('3/2');           // returns (float) 1.5
	 *     Support_Num::val('3\2');           // returns (float) 1.5
	 *     Support_Num::val('1000');          // returns (int) 1000
	 *     Support_Num::val('1,000');         // returns (int) 1000
	 *     Support_Num::val('1,000.5');       // returns (float) 1000.5
	 *     Support_Num::val('10000');         // returns (int) 10000
	 *     Support_Num::val('1st);            // returns (int) 1
	 *     Support_Num::val('second');        // returns (int) 2
	 *     Support_Num::val('one hundred');   // returns (int) 100
	 *     Support_Num::val('1,0,0');         // returns 0
	 *     Support_Num::val('abc');           // returns 0
	 *     Support_Num::val(array());         // returns 0
	 *     Support_Num::val(array('foo'));    // returns 1
	 *     Support_Num::val(new stdClass());  // returns 1
	 *
	 * @since  0.1.0
	 *
