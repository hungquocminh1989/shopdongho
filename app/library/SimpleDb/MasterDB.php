...
class MasterDB
{
	...
	{
		return ':MasterDB_' . $this->guid++ . '_MasterDB';
	}
	...
	protected function insert($table, $datas)
	{
		$stack = [];
		$columns = [];
		$fields = [];
	...
	protected function replace($table, $columns, $where = null)
	{
	...
	protected function has($table, $join, $where = null)
	{
		$map = [];
		$column = null;
	...
	protected function upsertRow($sql_param, $id = 'null', $table_name = NULL){
